...
func main() {
	...
	// price feeder flags
	rootCmd.PersistentFlags().Bool(flags.FlagPriceFeederEnable, false, "Enable price feeder")
	...
	rootCmd.PersistentFlags().String(flags.FlagPriceFeederLogLevel, "debug", "Price feeder log level")
